...
# TODO
X_bmi = FILL_THIS_IN
X_active_heartrate = FILL_THIS_IN
X_resting_heartrate = FILL_THIS_IN
X_vo2 = FILL_THIS_IN

lr_bmi = FILL_THIS_IN
lr_active_heartrate = FILL_THIS_IN
lr_resting_heartrate = FILL_THIS_IN
lr_vo2 = FILL_THIS_IN

lr_bmi.fit FILL_THIS_IN
lr_active_heartrate.fit FILL_THIS_IN
lr_resting_heartrate.fit FILL_THIS_IN
lr_vo2.fit FILL_THIS_IN

print("bmi: ", FILL_THIS_IN)
print("active_heartrate: ", FILL_THIS_IN)
print("resting_heartrate: ", FILL_THIS_IN)
print("vo2: ", FILL_THIS_IN)
...
# TODO
X_1 = ht_agg_pandas_df[ FILL_IN_FEATURES ]
X_2 = ht_agg_pandas_df[ FILL_IN_FEATURES ]
X_3 = ht_agg_pandas_df[ FILL_IN_FEATURES ]
X_4 = ht_agg_pandas_df[ FILL_IN_FEATURES ]
...
print("model 1: ", lr_1.score FILL_THIS_IN)
print("model 2: ", lr_2.score FILL_THIS_IN)
print("model 3: ", lr_3.score FILL_THIS_IN)
print("model 4: ", lr_4.score FILL_THIS_IN)
